...
class ReviewSubCell1: UICollectionViewCell {
    static let cellIdentifier = "ReviewSubCell1"
    ...
    lazy var reviewTextLabel: UILabel = {
        ...
        reviewTextLabel.text = "한줄 소개 입니다. 오늘 맥주 고 하나요"
