...
class ReviewSubCell3: UICollectionViewCell {
    static let cellIdentifier = "ReviewSubCell3"
    ...
    lazy var reviewTextLabel: UILabel = {
        ...
        reviewTextLabel.text = "한줄 소개 입니다. 오늘 위스키 고 하나요"
